...
while True:
    ...
    color_detect_area = cv2.convertScaleAbs(dst[180:300,270:390], alpha=alpha, beta=beta)
    dst[180:300,270:390] = color_detect_area 

    if  0 < np.average(color_detect_area) <= 60:
        cv2.putText(dst, "Black", (25, 50), cv2.FONT_HERSHEY_PLAIN,3, (0, 0, 0),3) 
    elif 60 < np.average(color_detect_area) <= 120:
